                    ...
                    <div class="">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Add Bank Deposit 
                                <%                                    
                                    if (session.getAttribute("deposit_status") != null) {
                                        if (session.getAttribute("deposit_status").equals("ok")) {
                                %>
                                ...
                                <%            
                                        ...
                                        session.removeAttribute("deposit_status");
                                    }
                                %>
                            </div>
                            <div class="panel-body">
                                <form action="../Bank_Deposit" id="select2Form" method="post">
                                    ...
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Payment Amount (Credit)</label>  
                                            <input type="text" class="form-control" name="payment_amount" pattern="^[1-9][0-9]*$"  id="payment_amount" placeholder="Enter payment" required=""/>
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Reference</label>  
                                    ...
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            ...
                                            %>
                                            <input type="text" class="form-control" name="to_date" id="to_date" value="<%=date_f%>" id="to_date" />
                                            <input type="text" name="p_status" value="deposit"  style="display: none" />
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
