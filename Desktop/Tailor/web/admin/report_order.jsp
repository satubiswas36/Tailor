                                                ...
                                                <tbody>
                                                    <%                                                        int sl = 1;
                                                        ...
                                                        try {
                                                            ...
                                                            String sql_show = "select * from ad_order where ord_bran_id = '" + branch_id + "' and (ord_status = 2 or ord_status = 3)order by ord_snlo desc";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center"><a href="order_details.jsp?ord_id=<%= rs_order_show.getString("ord_bran_order")%>&customer_id=<%= rs_order_show.getString("ord_cutomer_id")%>" style="text-decoration: none"><button class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span></button></a></td>
