...
<html>
    ...
    <body>
        <%
            ...
            if(session.getAttribute("product_name_by_group_location") != null){
                group_id  =(String) session.getAttribute("product_name_by_group_location");
            }
            %>
        ...
        <select style="width: 100%; height: 32px">
            ...
            <%
                try {
                    String sql_group_name = "select * from inv_product_name where prn_bran_id = '" + session.getAttribute("user_bran_id") + "' and prn_group_id = '"+group_id+"' order by prn_product_name asc ";
