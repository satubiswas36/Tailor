...
<html>
    ...
    <body>
        ...
        <div class="print" id="printableArea">
            ...
            <table width="30%"  style="margin: 0px;">
                <tr>
                    <td><%=srt_long%></td>
                    <td><%=srt_body%></td>
                    <td><%=srt_shoulder%></td>
            ...
            <table width="30%" style="margin: 0px;" border="1">
                <tr>
                    <td width="70" style="text-align: right">হাতা কুনু</td>
                    <td width="48" style="text-align: center"><%=srt_hand_qunu%></td>
                    <td width="70" style="text-align: right">হাতা মোজা</td>
                    <td width="48" style="text-align: center"><%=srt_hand_moja%></td>
                </tr>                
                <tr>
                ...
                <tr>
                    <td colspan="4"><%="অন্যান্য   : "+srt_others%></td>
                </tr>
            </table>
            <%
                    }
        ...
        <div class="print" id="printableAreapant">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">                
                <tr>
                    <td width="70" style="text-align: left"></td>                    
                    <td width="48" style="text-align: center"></td>
                    <td width="70" style="text-align: right">পকেট</td>
                    <td width="48" style="text-align: center"><%=pnt_pocket_type%></td>
                </tr>                
                <tr>
                ...
                <tr>
                    <td style="text-align: right">প্যান্টের সংখ্যা</td>
        ...
        <div id="printableAreablazer">
            ...
            <table width="30%"  style="margin: 0px;">
                <tr>
                    ...
                    <td><%=blz_shoulder%></td>
                    <td><%=blz_hand_long%></td>
                    <td><%=blz_hand_mohuri%></td>

                </tr>
                <tr>
                    <td></td>
                    <td><%=blz_bally%></td>
                    <td colspan="4"><%=blz_cross_back%></td>
                </tr>
                <tr>
                    <td></td>
                    <td><%=blz_hip%></td>
            ...
            <table border="1" width="50%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">বুতাম</td>
                    <td width="48" style="text-align: center"><%=blz_button_num + " টি"%></td>
                    <td width="70" style="text-align: right">নেপেল</td>
                    <td width="48" style="text-align: center"><%=blz_nepel%></td>
                </tr>                
                <tr>
        ...
        <div id="printableAreaphotua">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">হাতা কুনু</td>
                    <td width="48" style="text-align: center"><%=pht_hand_qunu%></td>
                    <td width="70" style="text-align: right">হাতা মোজা</td>
                    <td width="48" style="text-align: center"><%=pht_hand_moja%></td>
                </tr>                
                <tr>
                    <td style="text-align: right">বডি লুজ</td>
        ...
        <div id="printableArea">
            ...
            <table width="30%"  style="margin: 0px;">
                ...
                <tr>
                    <td></td>
                    <td><%=sfr_belly%></td>
                    <td colspan="4"><%=sfr_cross_back%></td>
                </tr>
                <tr>
                    <td></td>
                    <td><%=sfr_hip%></td>
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: left"></td>
                    <td width="48" style="text-align: center"></td>
                    <td width="70" style="text-align: right">বডি লুজ</td>
                    <td width="48" style="text-align: center"><%=sfr_body_loose%></td>
                </tr>                 
                <tr>
        ...
        <div id="printableAreapanjabi">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">বডি লুজ</td>
                    <td width="48" style="text-align: center"><%=pnjb_body_loose%></td>
                    <td width="70" style="text-align: right">পেট লুজ</td>
                    <td width="48" style="text-align: center"><%=pnjb_belly_loose%></td>
                </tr>                              
                <tr>                    
                    <td style="text-align: right">হিপ লুজ</td>
        ...
        <div id="printableAreapayjama">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">পকেট</td>
                    <td width="48" style="text-align: center"><%=pjma_pocket + " টি"%></td>
                    <td width="70" style="text-align: right">হিপ লুজ</td>
                    <td width="48" style="text-align: center"><%=pjma_hip_loose%></td>
                </tr>                
                <tr>
        ...
        <div id="printableAreamojibcort">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">বডি লুজ</td>
                    <td width="48" style="text-align: center"><%=mjc_body_loose%></td>
                    <td width="70" style="text-align: right">পেট লুজ</td>
                    <td width="48" style="text-align: center"><%=mjc_belly_loose%></td>
                </tr>                
                <tr>
                    <td style="text-align: right">হিপ লুজ</td>
        ...
        <div id="printableAreakable">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">বডি লুজ</td>
                    <td width="48" style="text-align: center"><%=kbl_body_loose%></td>
                    <td width="70" style="text-align: right">পেট লুজ</td>
                    <td width="48" style="text-align: center"><%=kbl_belly_loose%></td>
                </tr>                             
                <tr>
                    <td style="text-align: right">হিপ লুজ</td>
        ...
        <div id="printableAreakkoti">
            ...
            <table border="1" width="30%" style="margin-top: 10px;">
                <tr>
                    <td width="70" style="text-align: right">বডি লুজ</td>
                    <td width="48" style="text-align: center"><%=kt_body_loose%></td>
                    <td width="70" style="text-align: right">পেট লুজ</td>
                    <td width="48" style="text-align: center"><%=kt_belly_loose%></td>
                </tr>                                           
                <tr>
                    <td style="text-align: right">হিপ লুজ</td>
