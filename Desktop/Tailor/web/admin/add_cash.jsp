                            ...
                            <div class="panel-body">
                                <form action="" method="post">
                                    ...
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Title</label>  
                                            <input type="text" class="form-control" name="title" id="title" placeholder=" Enter Title" required=""/>
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Details</label>  
                                            <input type="text" class="form-control" name="details" id="group_name" placeholder="Enter Details" required=""/>
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Amount</label>  
                                            <input type="text" class="form-control" name="amount" id="group_name" placeholder="Enter Amount" required=""/>
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">To Date</label>  
                                            <%
                                                DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                                                Date date = new Date();
                                                String date_f = dateFormat.format(date);
                                            %>
                                            <input type="text" class="form-control" name="todate" value="<%=date_f%>" id="account_open_date" readonly=""/>
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
