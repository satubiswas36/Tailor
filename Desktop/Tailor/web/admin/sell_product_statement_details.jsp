                    ...
                    <div class="">
                        ...
                        <div class="panel panel-default" >
                            <div class="panel-heading" style="height: 45px">
                                <span style="font-size: 18px;">Customer Name : <%=customer%>, Invoice ID : <%=invoice%></span>
                            </div>
                            <div class="panel-body">
                                <div id="printableArea">
                                    <table class="table-responsive" style="border: none; margin: 0px; display: none" id="bran_image">
                                        ...
                                        <span style="font-size: 15px;">Customer Name : <%=customer%>, Invoice ID : <%=invoice%></span>
                                        <table class="table table-bordered" style="width: 100%;" id="recTable">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        String sql_invoice = "select * from inventory_details where pro_invoice_id = '" + invoice + "' and pro_deal_type = 4";
                                                        ...
                                                        while (rs_invoice.next()) {
                                                            ...
                                                            int qty = Integer.parseInt(rs_invoice.getString("pro_sell_quantity"));
                                                            double price = Double.parseDouble(rs_invoice.getString("pro_sell_price"));
