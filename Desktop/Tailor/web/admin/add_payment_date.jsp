                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form action="" method="post" >
                                   ...
                                   <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Payment Amount</label>  
                                            <input type="text" class="form-control" name="payment_amount" id="payment_amount" placeholder="Enter Payment Amount" />
                                        </div>
                                    </div>
                                    <div class="row  form-group">
                                        <div class="col-sm-6">
                                            <label for="name" style="margin-bottom:  0px">Payment Date</label>  
                                            <input type="date" class="form-control" name="branch_name" id="branch_name" placeholder="Enter Branch Name" />
                                        </div>
                                    </div>                                    
