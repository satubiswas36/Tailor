                                ...
                                <form action="../Photua_measurment" method="post">
                                    ...
                                    <div class="row">                            
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" class="form-control" name="pht_long" id="long" <% if (pht_long != null) {%> value="<%= pht_long%>"<%} %>  style="margin-bottom: 8px;" required=""/>
                                        </div>
                                        <div class="col-sm-2">
                                            <label for="" class="control-label" style="margin-bottom: 0px;">বডি</label>
                                            <input type="text" class="form-control" name="pht_body" id="body" <input type="text" class="form-control"  <% if (pht_body != null) {%> value="<%= pht_body%>"<%} %>  style="margin-bottom: 8px;" required=""/>
